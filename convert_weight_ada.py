'''
For weight conversion of stylegan2-ada pkl trained with auto config to pt file
Changes made as per this issue ( https://github.com/rosinality/stylegan2-pytorch/issues/163 )
'''
import argparse
import os
import sys
...
def fill_statedict(state_dict, vars, size):
    ...
    for i in range(2):   #8 in place of 2
...
if __name__ == "__main__":
    ...
    g = Generator(size, 512, 2, channel_multiplier=args.channel_multiplier)   #8 in place of 2
    ...
    if args.gen:
        g_train = Generator(size, 512, 2, channel_multiplier=args.channel_multiplier)   #8 in place of 2
